...
export const DarkModeToggle: React.FC<{ isDarkMode: boolean; toggleDarkMode: () => void }> = ({
  isDarkMode,
  toggleDarkMode,
}) => {
  return (
    <div className='flex flex-col justify-center px-2 items-center'>
      <input
        ...
        checked={isDarkMode}
      />
      <label htmlFor='light-switch' className='relative cursor-pointer flex items-center justify-center'>
        {isDarkMode ? (
          <svg className='w-9 h-9' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg' stroke='#ffffff'>
