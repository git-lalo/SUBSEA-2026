...
class CameraManager:
    ...
    def start_stereo_cam_L(self):
        self.cam_stereoL = Camera("StereoL", RTSP_FEED_STEREO_L)
    ...
    def start_stereo_cam_R(self):
        self.cam_stereoR = Camera("StereoR", RTSP_FEED_STEREO_R)
    ...
    def start_down_cam(self):
        self.cam_down = Camera("Down", RTSP_FEED_DOWN)
    ...
    def start_manipulator_cam(self):
        self.cam_manipulator = Camera("Manipulator", RTSP_FEED_MANIPULATOR)
